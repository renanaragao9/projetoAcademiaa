          ...
          <form class="col s12" id="payments" action="{{ route('admin.payments.store') }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="row">                  
              <div class="input-field col s12 l12">
                ...
                <h5 id="homeTitle" class="center">Aluno {{ $user->name }}</h5>
              </div>
              ...
              <div class="input-field col s12 l12">      
                ...
                <a href="{{ route('admin.payments.indexUser', $user->id) }}" class="waves-effect waves-light btn right light-blue darken-4 col s12 l5" id=""><i class="material-icons right">table_rows</i>Pagamentos</a>
