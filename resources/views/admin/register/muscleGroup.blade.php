...
@section('title', 'Cadastrar novo Grupo Muscular')
  ...
  <div class="row">
    <div class="card white">
      <div class="card-content">           
        <div class="row">
          <form class="col s12" id="form_create" action="{{ route('admin.groupmuscle.store') }}" method="POST" enctype="multipart/form-data">
            @csrf
            <div class="row">                  
              <div class="input-field col s12 l12">
                <h3 id="pageTitle" class="center">Cadastrar <br> Grupo Muscular</h3>
              </div>
