  ...
  <div class="row">
    <div class="card white">
      <div class="card-content">           
        <div class="row">
          <form class="col s12" id="form_group_muscle" action="{{ route('admin.register.groupmuscle.create') }}" method="POST" enctype="multipart/form-data">
            @csrf
            <div class="row">                  
              <div class="input-field col s12 l12">
                <h3 id="homeTitle" class="center">Cadastrar <br> Grupo Muscular</h3>
              </div>

              <div class="input-field col s12 l12">
                <input name="name_gmuscle" type="text" class="validate" id="icon-nome" required>
              ...
              <div class="input-field col s12 l12">      
                ...
                <a href="{{ route('admin.table.groupmuscle') }}" class="waves-effect waves-light btn right light-blue darken-4 col s12 l5" id=""><i class="material-icons right">table_rows</i>Listar Registros</a>
