                ...
                <form class="col s12" id="form_group_muscle" action="{{ route('admin.register.assessment.create') }}" method="POST" enctype="multipart/form-data">
                  ...
                  <div class="row">
                    ...
                    <div class="input-field col s12 l12" id="input-exercicio">
                      <h3 id="titleColor" class="center">Avaliação</h3>
                  ...
                  <div class="input-field col s12 l12">      
                    ...
                    <a href="#" class="waves-effect waves-light btn right light-blue darken-4 col s12 l5" id=""><i class="material-icons right">table_rows</i>Ficha</a>
