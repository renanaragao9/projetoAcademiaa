...
@section('title', 'Tabela do Tipo Mensalidade')
  ...
  <div class="card z-depth-5">
    <div class="card-content">
      <div class="col s12 l12">
        <h3 class="center" id="homeTitle">Listagem de Tipos<br> de Mensalidades</h3>
        <a href="{{ route('admin.register.monthlyType') }}" class="waves-effect waves-light btn left light-blue darken-4 col s12 l2" id="bottom-form-action"><i class="material-icons right">arrow_back</i>Voltar</a>
      </div>
          ...
          @foreach($monthlyTypes as $monthlyType)
            <tr>
              ...
              <td>    
                ...
                <form action="{{ route('admin.monthlyType.destroy', $monthlyType->id_monthly_type) }}" method="POST" class="delete-form">
                  @csrf
                  @method('DELETE')
                  <input type="hidden" name="id" value="{{ $monthlyType->id_monthly_type }}">
                  <button class="btn-floating tooltipped red darken-4 btn-large waves-effect waves-light erd delete-button" id="bottom-table-action" data-position="bottom" data-tooltip="Excluir"><i class="material-icons">delete_forever</i></button>
                </form>
              </td>
            </tr>
          @endforeach
