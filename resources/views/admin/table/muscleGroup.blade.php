  ...
  <div class="card z-depth-5">
    <div class="card-content">
      <div class="col s12 l12">
        ...
        <a href="{{ route('admin.register.groupmuscle') }}" class="waves-effect waves-light btn right light-blue darken-4 col s12 l2" id="bottom-form-action"><i class="material-icons right">add</i>Adicionar</a>
      </div>
