...
CREATE TABLE IF NOT EXISTS `exercises` (
  ...
  `gmuscle_id` bigint unsigned NOT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id_exercise`),
  KEY `exercises_id_gmuscle_fk_foreign` (`gmuscle_id`) USING BTREE,
  CONSTRAINT `exercises_id_gmuscle_fk_foreign` FOREIGN KEY (`gmuscle_id`) REFERENCES `muscle_group` (`id_gmuscle`) ON DELETE CASCADE
) ENGINE=InnoDB AUTO_INCREMENT=136 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

-- Copiando dados para a tabela academia.exercises: ~109 rows (aproximadamente)
INSERT INTO `exercises` (`id_exercise`, `name_exercise`, `image_exercise`, `gif_exercise`, `gmuscle_id`, `created_at`, `updated_at`) VALUES
...
CREATE TABLE IF NOT EXISTS `fichas` (
  ...
  `user_creator_id` bigint unsigned NOT NULL,
  `training_id` bigint unsigned NOT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id_ficha`),
  KEY `fichas_id_exercise_fk_foreign` (`exercise_id`) USING BTREE,
  KEY `fichas_id_user_fk_foreign` (`user_id`) USING BTREE,
  KEY `fichas_id_user_creator_fk_foreign` (`user_creator_id`) USING BTREE,
  KEY `fichas_id_training_fk_foreign` (`training_id`) USING BTREE,
  KEY `fichas_id_gmuscle_fk_to_ficha_foreign` (`gmuscle_id`) USING BTREE,
  CONSTRAINT `fichas_id_exercise_fk_foreign` FOREIGN KEY (`exercise_id`) REFERENCES `exercises` (`id_exercise`) ON DELETE CASCADE,
  CONSTRAINT `fichas_id_gmuscle_fk_to_ficha_foreign` FOREIGN KEY (`gmuscle_id`) REFERENCES `muscle_group` (`id_gmuscle`) ON DELETE CASCADE,
  CONSTRAINT `fichas_id_training_fk_foreign` FOREIGN KEY (`training_id`) REFERENCES `training_division` (`id_training`) ON DELETE CASCADE,
  CONSTRAINT `fichas_id_user_creator_fk_foreign` FOREIGN KEY (`user_creator_id`) REFERENCES `users` (`id`),
  CONSTRAINT `fichas_id_user_fk_foreign` FOREIGN KEY (`user_id`) REFERENCES `users` (`id`) ON DELETE CASCADE
) ENGINE=InnoDB AUTO_INCREMENT=93 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

-- Copiando dados para a tabela academia.fichas: ~30 rows (aproximadamente)
INSERT INTO `fichas` (`id_ficha`, `order`, `serie`, `repetition`, `weight`, `rest`, `description`, `exercise_id`, `gmuscle_id`, `user_id`, `user_creator_id`, `training_id`, `created_at`, `updated_at`) VALUES
...
-- Copiando estrutura para tabela academia.muscle_group
CREATE TABLE IF NOT EXISTS `muscle_group` (
  `id_gmuscle` bigint unsigned NOT NULL AUTO_INCREMENT,
  `name` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `observation` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT '-',
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id_gmuscle`)
) ENGINE=InnoDB AUTO_INCREMENT=14 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

-- Copiando dados para a tabela academia.muscle_group: ~8 rows (aproximadamente)
INSERT INTO `muscle_group` (`id_gmuscle`, `name`, `observation`, `created_at`, `updated_at`) VALUES
	...
	(7, 'Costas', 'teste', '2023-09-23 04:33:08', '2024-03-05 18:39:13'),
...
INSERT INTO `sessions` (`id`, `user_id`, `ip_address`, `user_agent`, `payload`, `last_activity`) VALUES
	('LqgNqhCGX4rXIaxaKIjlhqk22Vp4jJuP9Ltbngxg', 1, '127.0.0.1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/122.0.0.0 Safari/537.36', '', 1710285615);
...
CREATE TABLE IF NOT EXISTS `statistics` (
  ...
  `id_ficha_fk` bigint unsigned DEFAULT NULL,
  `assessment_id` bigint DEFAULT NULL,
  `called_id` bigint DEFAULT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
...
-- Copiando dados para a tabela academia.statistics: ~3 rows (aproximadamente)
INSERT INTO `statistics` (`id_statistic`, `id_user_fk`, `id_ficha_fk`, `assessment_id`, `called_id`, `created_at`, `updated_at`) VALUES
	(18, 1, 92, NULL, NULL, '2024-01-30 01:48:02', '2024-01-30 01:48:02'),
	(19, 1, 73, NULL, NULL, '2024-01-31 03:15:16', '2024-01-31 03:15:16'),
	(20, 1, 92, NULL, NULL, '2024-02-23 17:57:57', '2024-02-23 17:57:57');
...
INSERT INTO `training_division` (`id_training`, `name`, `observation`, `created_at`, `updated_at`) VALUES
	(1, 'Perna', '-', '2023-09-23 04:20:41', '2023-09-23 04:20:41'),
	(2, 'Peito, Tríceps e Ombro', '-', '2023-09-23 04:21:04', '2023-09-23 04:21:04'),
	(3, 'Costas, Bíceps e Trapézio', '1', '2023-09-23 04:21:36', '2024-03-05 18:04:04'),
	(4, 'teste', '-', '2023-09-23 04:21:58', '2023-09-23 04:21:58'),
	(11, 'teste', 'teste', '2024-03-05 17:49:37', '2024-03-05 17:49:37');
