...
-- Copiando dados para a tabela academia.monthly_type: ~3 rows (aproximadamente)
INSERT INTO `monthly_type` (`id_monthly_type`, `name_monthly`, `value`, `observation`, `created_at`, `updated_at`) VALUES
	(1, 'faz o l', 159.99, 'teste', '2024-02-21 15:00:02', '2024-02-21 16:59:53'),
	(9, 'teste', 59.80, 'sdad', '2024-02-21 15:19:37', '2024-02-21 15:35:08'),
	(10, 'teste', 79.99, NULL, '2024-02-21 15:34:46', '2024-02-21 15:34:46');
...
CREATE TABLE IF NOT EXISTS `payments` (
  ...
  `type_payment` varchar(260) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `date_payment` date DEFAULT NULL,
  `value_payment` decimal(5,2) DEFAULT NULL,
  `monthly_type_id` int DEFAULT NULL,
  `user_id_fk` int DEFAULT NULL,
  `user_creator_fk` int DEFAULT NULL,
  `created_at` timestamp NULL DEFAULT CURRENT_TIMESTAMP,
  `updated_at` timestamp NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  PRIMARY KEY (`id_payment`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

-- Copiando dados para a tabela academia.payments: ~0 rows (aproximadamente)
...
INSERT INTO `sessions` (`id`, `user_id`, `ip_address`, `user_agent`, `payload`, `last_activity`) VALUES
	('HMtUyeOhLlOYBHqEvg3jslPMMAVNSBrsun4FmlXt', 1, '127.0.0.1', 'Mozilla/5.0 (X11; Ubuntu; Linux x86_64; rv:123.0) Gecko/20100101 Firefox/123.0', '', 1708537298),
	('OWuo92HnKQy1omqMjIQ1jgene3SfpVdijo8BxsAv', NULL, '127.0.0.1', 'Mozilla/5.0 (X11; Ubuntu; Linux x86_64; rv:123.0) Gecko/20100101 Firefox/123.0', '', 1708535102),
	('USgG9b7xZnISTjEUkH9tpGo3zlc83Gu8azqx0UCe', NULL, '127.0.0.1', 'Mozilla/5.0 (X11; Ubuntu; Linux x86_64; rv:123.0) Gecko/20100101 Firefox/123.0', 'YTozOntzOjY6Il90b2tlbiI7czo0MDoiSm1oUlFWR1EwR3F2SjVodTJRdkEzNkVnZm51bUZCTUJpWXd0MEdKNyI7czo5OiJfcHJldmlvdXMiO2E6MTp7czozOiJ1cmwiO3M6Mjc6Imh0dHA6Ly8xMjcuMC4wLjE6ODAwMC9sb2dpbiI7fXM6NjoiX2ZsYXNoIjthOjI6e3M6Mzoib2xkIjthOjA6e31zOjM6Im5ldyI7YTowOnt9fX0=', 1708535102);
