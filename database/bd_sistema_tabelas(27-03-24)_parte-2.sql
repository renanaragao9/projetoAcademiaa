...
CREATE TABLE IF NOT EXISTS `Expenses` (
  ...
  `description_expense` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `observation_expense` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
INSERT INTO `sessions` (`id`, `user_id`, `ip_address`, `user_agent`, `payload`, `last_activity`) VALUES
	('KevTJjkeYt81VRF0LbmC2kN5sw80rqGo4nyVBHgE', 1, '127.0.0.1', 'Mozilla/5.0 (X11; Ubuntu; Linux x86_64; rv:123.0) Gecko/20100101 Firefox/123.0', '', 1711561255);
