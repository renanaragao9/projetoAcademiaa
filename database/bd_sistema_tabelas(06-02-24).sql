...
-- Copiando estrutura para tabela academia.media
CREATE TABLE IF NOT EXISTS `media` (
  `id_media` bigint NOT NULL AUTO_INCREMENT,
  `tipo_media` int DEFAULT NULL,
  `img_media` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `link_media` varchar(260) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `title_media` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `description_media` text COLLATE utf8mb4_unicode_ci,
  `tags_media` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
-- Copiando dados para a tabela academia.media: ~4 rows (aproximadamente)
INSERT INTO `media` (`id_media`, `tipo_media`, `img_media`, `link_media`, `title_media`, `description_media`, `tags_media`, `user_id`, `created_at`, `updated_at`) VALUES
	(1, 1, NULL, 'asdasd', NULL, 'sdasd', 'asda', 1, '2024-02-06 03:02:16', '2024-02-06 03:02:16'),
	(2, 2, NULL, 'asda', 'asda', 'asda', 'asdas', 1, '2024-02-06 03:04:51', '2024-02-06 03:04:51'),
	(3, 1, '45d45b931acb577beb14267c689439af.jpg', 'asda', 'asdas', 'dasda', 'dasd', 1, '2024-02-06 03:06:54', '2024-02-06 03:06:54'),
	(4, 1, '3dee64845ee6fad48568fa52745a126e.jpg', 'erwEr', 'werw', 'wer', 'werwr', 1, '2024-02-06 03:07:13', '2024-02-06 03:07:13');
...
INSERT INTO `sessions` (`id`, `user_id`, `ip_address`, `user_agent`, `payload`, `last_activity`) VALUES
	('4zv5tg9M0ZZuiz2QxfG7fBtquIUzGBB8OOdNKLSX', 1, '192.168.1.101', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/121.0.0.0 Safari/537.36', '', 1707188918);
...
INSERT INTO `users` (`id`, `name`, `phone`, `sexo`, `date`, `profile`, `email`, `email_verified_at`, `password`, `two_factor_secret`, `two_factor_recovery_codes`, `two_factor_confirmed_at`, `remember_token`, `current_team_id`, `profile_photo_path`, `created_at`, `updated_at`) VALUES
	(1, 'Renan da Silva Aragão', '85984174827', 'Masculino', '2023-10-22', 1, 'renanaragao159@gmail.com', NULL, '$2y$10$2VI9UtFck1r.pPN4eIGHDeOBRZ19BfnNAp5r/5GX/QTAhb2ZKAXEy', NULL, NULL, NULL, NULL, NULL, '65b9b7fad8554.jpeg', '2023-09-23 04:09:49', '2024-01-31 03:01:14'),
