...
-- Copiando dados para a tabela academia.calleds: ~1 rows (aproximadamente)
...
-- Copiando dados para a tabela academia.fichas: ~32 rows (aproximadamente)
...
-- Copiando dados para a tabela academia.payments: ~14 rows (aproximadamente)
INSERT INTO `payments` (`id_payment`, `form_payment`, `date_payment`, `date_due_payment`, `value_payment`, `monthly_type_id`, `user_id`, `user_id_creator`, `created_at`, `updated_at`) VALUES
	...
	(16, 'Pix', '2024-03-22', '2024-05-22', 145.00, 9, 7, 1, '2024-03-22 03:50:23', '2024-03-22 03:50:23');
...
INSERT INTO `sessions` (`id`, `user_id`, `ip_address`, `user_agent`, `payload`, `last_activity`) VALUES
	('9gaf8bIMZPkWZ7U1c9QqRXXNXArPezsU3tPzDjPC', 1, '192.168.1.102', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/123.0.0.0 Safari/537.36', '', 1711080802),
	('CvJrzsuhZ3U9taWv8bAQS3IcNu7nAHj90Qurd07p', 1, '127.0.0.1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/123.0.0.0 Safari/537.36', '', 1711078188),
	('jQ2ot1mPm7Ng1Wcx6IwQD4aqGaskRbFi3Xpb7Gqm', 7, '192.168.1.104', 'Mozilla/5.0 (Linux; Android 10; K) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/122.0.0.0 Mobile Safari/537.36', '', 1711080818),
	('WDDeeeh800LrFykgZyP9Hwwj3X1W78Fg3b2kr5vt', 7, '127.0.0.1', 'Mozilla/5.0 (iPhone; CPU iPhone OS 14_6 like Mac OS X) AppleWebKit/605.1.15 (KHTML, like Gecko) Version/14.0.3 Mobile/15E148 Safari/604.1', '', 1711078698);
...
-- Copiando dados para a tabela academia.users: ~7 rows (aproximadamente)
INSERT INTO `users` (`id`, `name`, `phone`, `sexo`, `date`, `profile`, `email`, `email_verified_at`, `password`, `two_factor_secret`, `two_factor_recovery_codes`, `two_factor_confirmed_at`, `remember_token`, `current_team_id`, `profile_photo_path`, `created_at`, `updated_at`) VALUES
	(1, 'Renan da Silva Aragãoo', '85984174828', 'Masculino', '2023-10-22', 1, 'renanaragao159@gmail.com', NULL, '$2y$10$2VI9UtFck1r.pPN4eIGHDeOBRZ19BfnNAp5r/5GX/QTAhb2ZKAXEy', NULL, NULL, NULL, NULL, NULL, '65b9b7fad8554.jpeg', '2023-09-23 04:09:49', '2024-03-20 01:31:13'),
	...
	(7, 'Raquel Serafim Lima', '85984174827', 'Feminino', '1999-12-24', 0, 'raquelserafim@gmail.com', NULL, '$2y$10$9fEpHUz6kmaoowHf.w9F.OS2wUp/LDEimRu3N357sxMjJsn0RKS8K', NULL, NULL, NULL, NULL, NULL, '65fcfe6649cd4.jpg', '2024-03-22 02:43:32', '2024-03-22 04:01:44');
