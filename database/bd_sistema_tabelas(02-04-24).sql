...
CREATE TABLE IF NOT EXISTS `expenses` (
  ...
  `value_expense` decimal(5,2) DEFAULT NULL,
  `description_expense` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `observation_expense` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
-- Copiando dados para a tabela academia.expenses: ~7 rows (aproximadamente)
INSERT INTO `expenses` (`id_expense`, `tipo_expense`, `data_expense`, `value_expense`, `description_expense`, `observation_expense`, `user_id`, `created_at`, `updated_at`) VALUES
	(3, 1, '2024-03-27', 50.00, NULL, 'teste', 1, '2024-03-27 23:08:30', '2024-03-27 23:08:30'),
	(4, 1, '2024-03-27', 520.00, NULL, 'fg', 1, '2024-03-27 23:09:13', '2024-03-27 23:09:13'),
	(5, 1, '2024-03-27', 50.00, 'tttt', 'aaa', 1, '2024-03-27 23:10:07', '2024-03-28 00:27:43'),
	(6, 2, '2024-03-28', 100.00, 'Compra de Papel Higienico', 'teste', 1, '2024-03-28 04:21:32', '2024-03-28 04:21:32'),
	(7, 2, '2024-03-28', 100.00, 'Compra de Cabos', 'Loja morea', 1, '2024-03-28 04:21:51', '2024-03-28 04:21:51'),
	(8, 1, '2024-04-28', 50.00, 'teste', 'teste', 1, '2024-03-28 04:25:55', '2024-03-28 04:25:55'),
	(9, 2, '2024-04-24', 20.00, 'teste', 'teste', 1, '2024-03-28 04:26:05', '2024-03-28 04:26:05');
...
INSERT INTO `medias` (`id_media`, `type_media`, `img_media`, `link_media`, `title_media`, `description_media`, `tags_media`, `id_user_fk`, `created_at`, `updated_at`) VALUES
	...
	(17, 1, 'c7cf33c8a7226dffd7933b010ac41c94.jpg', NULL, 'Teste celular', 'Stedte', 'Teste', 1, '2024-03-22 04:04:50', '2024-03-22 04:04:50');
...
-- Copiando dados para a tabela academia.monthly_type: ~5 rows (aproximadamente)
INSERT INTO `monthly_type` (`id_monthly_type`, `name_monthly`, `value`, `months`, `observation`, `created_at`, `updated_at`) VALUES
	...
	(12, 'Teste', 700.00, 3, 'Teste', '2024-03-22 04:06:03', '2024-03-22 04:06:03');
...
INSERT INTO `musclegroup` (`id_gmuscle`, `name_gmuscle`, `created_at`, `updated_at`) VALUES
	...
	(13, 'Teste celular', '2024-03-22 04:03:02', '2024-03-22 04:03:02');
...
-- Copiando dados para a tabela academia.payments: ~18 rows (aproximadamente)
...
INSERT INTO `sessions` (`id`, `user_id`, `ip_address`, `user_agent`, `payload`, `last_activity`) VALUES
	('8Vm6uAXWcb85g0gukpZnWcvVkHimmItPDGLcrXeM', 1, '127.0.0.1', 'Mozilla/5.0 (X11; Ubuntu; Linux x86_64; rv:123.0) Gecko/20100101 Firefox/123.0', '', 1712083816),
	('GTMT22iMUWtIGEShLnMFTrN62nCSeADVkYb23mJM', NULL, '127.0.0.1', 'Mozilla/5.0 (X11; Ubuntu; Linux x86_64; rv:123.0) Gecko/20100101 Firefox/123.0', '', 1712081156),
	('hGJdFjrSGe5cokxJZcoyqFDlq86hZJpu9VTYJwdi', NULL, '127.0.0.1', 'Mozilla/5.0 (X11; Ubuntu; Linux x86_64; rv:123.0) Gecko/20100101 Firefox/123.0', '', 1712083975);
...
-- Copiando dados para a tabela academia.training_division: ~6 rows (aproximadamente)
INSERT INTO `training_division` (`id_training`, `name_training`, `created_at`, `updated_at`) VALUES
	...
	(11, 'Teste celulatr', '2024-03-22 04:02:43', '2024-03-22 04:02:43');
...
INSERT INTO `users` (`id`, `name`, `phone`, `sexo`, `date`, `profile`, `email`, `email_verified_at`, `password`, `two_factor_secret`, `two_factor_recovery_codes`, `two_factor_confirmed_at`, `remember_token`, `current_team_id`, `profile_photo_path`, `due_date`, `created_at`, `updated_at`) VALUES
	(1, 'Renan da Silva Aragãoo', '85984174828', 'Masculino', '2023-10-22', 2, 'renanaragao159@gmail.com', NULL, '$2y$10$ebyrLJtFFkcP3lTI8jdeK.biVYdH1K7p84GZxgYF3AWBGOG5QDNZi', NULL, NULL, NULL, NULL, NULL, '65b9b7fad8554.jpeg', '2024-05-02', '2023-09-23 04:09:49', '2024-04-02 16:33:12'),
	(2, 'Maria Clara', '85984174827', 'Feminino', '2008-06-13', 0, 'renanaragao159159@gmail.com', NULL, '$2y$10$ovLzaKCqtmt04ia/h3nfzuXhYtkcRXNZR/BS9YLfuo11PjCfG1E5K', NULL, NULL, NULL, NULL, NULL, NULL, '2024-04-02', '2023-09-23 04:43:13', '2024-04-02 17:10:51'),
	(3, 'Juan Victor', '8598417482', 'Masculino', '2006-11-27', 2, 'renan@teste.com', NULL, '$2y$10$O5Gg/TPHMIY4PMqW4TAMiudmP4Q/BYbY2p4FHcm8NShZlB5ayM0Na', NULL, NULL, NULL, NULL, NULL, '6549ab559d0bd.jpg', '2024-06-02', '2023-09-23 04:44:03', '2024-04-02 16:38:17'),
	(4, 'Renan', NULL, NULL, NULL, 0, 'keltry@teste.com', NULL, '$2y$10$xCMzwl4h9v3nIAsAcEN1PuvitKOH6JzKlglWjRQtOOwnu1dh3eDRW', NULL, NULL, NULL, NULL, NULL, NULL, NULL, '2023-10-10 03:23:00', '2024-04-01 17:40:49'),
	(5, 'teste', '85984174827', 'Masculino', '2000-02-10', 0, 'teste@testando.com.br', NULL, '$2y$10$Fve2EFNT/8ckPHj4hSEAOuFjxQDUl6N5vRmb1BXCzNVfnpChu7UyO', NULL, NULL, NULL, NULL, NULL, 'image_default.png', NULL, '2023-11-15 04:21:12', '2023-11-15 04:21:12'),
	(6, 'Luiza Teste', '8598417482', 'Feminino', '1999-12-24', 0, 'renan@teste.com.edu', NULL, '$2y$10$z7Tg35vThl5RIpHEDHg.JuhdQtZt6pbs.35/6uSlm/7nxys1xwNkq', NULL, NULL, NULL, NULL, NULL, 'image_default.png', NULL, '2024-01-04 02:06:40', '2024-01-04 02:06:40'),
	(7, 'Raquel Serafim Lima', '85984174827', 'Feminino', '1999-12-24', 0, 'raquelserafim@gmail.com', NULL, '$2y$10$9fEpHUz6kmaoowHf.w9F.OS2wUp/LDEimRu3N357sxMjJsn0RKS8K', NULL, NULL, NULL, NULL, NULL, '65fcfe6649cd4.jpg', NULL, '2024-03-22 02:43:32', '2024-03-22 04:01:44'),
	(8, 'Lucas Firmiano', '85984174827', 'Masculino', '2001-05-12', 0, 'lucasgirao@gmail.com', NULL, '$2y$10$doi72J4RODRfXTGsMjwlE.Wj6CpzbJJt6aUQeTbOgbjhhe/u4tdLm', NULL, NULL, NULL, NULL, NULL, 'image_default.png', NULL, '2024-04-02 16:58:15', '2024-04-02 16:58:15'),
	(9, 'Anselmo Martins', '85984174827', 'Masculino', '2002-06-02', 0, 'anselmomartins@gmail.com', NULL, '$2y$10$.MIBhKHfqPCtDr8PHbnFsOOLQn11lpbHJ2rkSNFnyxUbOr5oDoC0S', NULL, NULL, NULL, NULL, NULL, 'image_default.png', NULL, '2024-04-02 16:58:53', '2024-04-02 16:58:53'),
	(10, 'Eric Aquino', '85984174827', 'Masculino', '2000-04-17', 0, 'ericaquino@gmail.com', NULL, '$2y$10$gZpEx.rNUX6SG5vYd2eS7uO6sVF/bWhoZSE5a8CcIS3xBMKO8nRwe', NULL, NULL, NULL, NULL, NULL, 'image_default.png', NULL, '2024-04-02 16:59:25', '2024-04-02 16:59:25'),
	(11, 'Paola Abraço', '85984174827', 'Feminino', '1999-12-24', 0, 'paolaabraco@gmail.com', NULL, '$2y$10$.mdMHSQ.T7hLDSfYlf3SAu9HmeqZjbh/TY6K4b28.7YrCqRjhNabS', NULL, NULL, NULL, NULL, NULL, 'image_default.png', NULL, '2024-04-02 17:00:23', '2024-04-02 17:00:23');
