...
CREATE TABLE IF NOT EXISTS `exercises` (
  ...
  `gif_exercise` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT 'default_gif.jpg',
...
INSERT INTO `exercises` (`id_exercise`, `name_exercise`, `image_exercise`, `gif_exercise`, `id_gmuscle_fk`, `created_at`, `updated_at`) VALUES
	...
	(45, 'Leg Press Unilateral', 'f6a1115d0a4f373a734f77f851dc4cbcleg-press-unilateral.jpg', 'default_gif.jpg', 1, '2024-01-11 15:48:26', '2024-01-11 15:48:26'),
	...
	(52, 'Crucifixo Máquina', '1a5eedf5f6cc4ae4949222f77ce71263crucifixo-maquina.jpg', 'default_gif.jpg', 3, '2024-01-11 18:35:22', '2024-01-11 18:35:22'),
	...
	(59, 'Supino Declinado', '7a34dad7354f83f2b4b0d696f552337dsupino-declinado.jpg', 'default_gif.jpg', 3, '2024-01-12 13:33:15', '2024-01-12 13:33:15'),
	...
	(64, 'Supino Fechado', '5a357e6906dfb8f4b4e62a71ac24f440supino-fechado.jpg', 'default_gif.jpg', 3, '2024-01-12 13:48:09', '2024-01-12 13:48:09'),
	...
	(91, 'Rosca 21', 'c404d284d7b390d8154eb66a0cac9633rosca-21.png', 'default_gif.jpg', 5, '2024-01-24 00:00:50', '2024-01-24 00:00:50'),
	...
	(128, 'Elevação Frontal na Polia', '7c4cf60ed8acf462721ec12ad462b13belevacao-frontal-polia.jpg', 'default_gif.jpg', 2, '2024-01-26 02:57:37', '2024-01-26 02:58:05'),
	...
	(132, 'Elevação Unilateral', '59f564c4b55ed375c8f431287a8b4b54elevacao-unilateral.jpg', 'default_gif.jpg', 2, '2024-01-26 03:01:07', '2024-01-26 03:01:07'),
...
-- Copiando dados para a tabela academia.expenses: ~8 rows (aproximadamente)
...
INSERT INTO `fichas` (`id_ficha`, `order`, `serie`, `repetition`, `weight`, `rest`, `description`, `id_exercise_fk`, `id_gmuscle_fk_to_ficha`, `id_user_fk`, `id_user_creator_fk`, `id_training_fk`, `created_at`, `updated_at`) VALUES
	...
	(73, '1', '4', '8 - 12', NULL, NULL, NULL, 68, 6, 1, 1, 3, '2024-01-29 23:20:44', '2024-04-11 16:23:44'),
...
INSERT INTO `sessions` (`id`, `user_id`, `ip_address`, `user_agent`, `payload`, `last_activity`) VALUES
	('4WRcudzXvdaeG3R5IJH96MosF2qjoCEJ74GftRNu', NULL, '127.0.0.1', 'Mozilla/5.0 (X11; Ubuntu; Linux x86_64; rv:123.0) Gecko/20100101 Firefox/123.0', '', 1712853602),
	('MfT8VuOJWi4iSH6ydODCGLLeKPBdt5nWjRf0DH0V', 1, '127.0.0.1', 'Mozilla/5.0 (Linux; Android 11; SAMSUNG SM-G973U) AppleWebKit/537.36 (KHTML, like Gecko) SamsungBrowser/14.2 Chrome/87.0.4280.141 Mobile Safari/537.36', '', 1712857067),
	('qzM9q9K2cAEDZGrWdLHeF5B8wZGv6UQbVXWHY83P', NULL, '127.0.0.1', 'Mozilla/5.0 (X11; Ubuntu; Linux x86_64; rv:123.0) Gecko/20100101 Firefox/123.0', '', 1712855742);
...
INSERT INTO `training_division` (`id_training`, `name_training`, `created_at`, `updated_at`) VALUES
	...
	(12, 'teste', '2024-04-11 17:27:12', '2024-04-11 17:27:12');
